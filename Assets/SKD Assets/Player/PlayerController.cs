...
public class PlayerController : MonoBehaviour
{
    ...
    public Vector3 firstPersonLocalPos = new Vector3(0f, 0.6f, 0f);
    public Vector3 thirdPersonLocalPos = new Vector3(0f, 1.5f, -3f);
    ...
    // ── Inventory lock ─────────────────────────────────────────────────────
    // Set to true by InventoryUI when the panel opens — freezes move + look
    ...
    private void Update()
    {
        // When inventory is open skip movement and camera entirely
        if (inventoryOpen)
        {
